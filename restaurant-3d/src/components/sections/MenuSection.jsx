...
const MenuSection = ({ title, items, modelType }) => {
  ...
  return (
    <section className="min-h-screen flex items-center justify-between pl-4 md:pl-20 pr-4 md:pr-20 relative">
      {/* Menu Content */}
      ...
      <div className="hidden lg:block w-1/2 h-full absolute right-0 top-0 pointer-events-none">
