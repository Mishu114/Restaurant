...
const MenuSection = ({ title, items, modelType }) => {
  ...
  return (
    <section className={`min-h-screen flex flex-col items-center justify-between pl-4 md:pl-20 pr-4 md:pr-20 relative ${getBgColor()} pt-[10vh]`}>
      {/* Menu Content */}
      ...
      <div className="hidden lg:block w-full h-full absolute right-0 top-0 pointer-events-none ">
